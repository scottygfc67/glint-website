            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-blue-600 text-white px-6 py-4 rounded-lg font-semibold text-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">support@glint.com</p>
                      <p className="text-gray-600">returns@glint.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Ships worldwide</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  ...
                  <a href="/money-back-guarantee" className="block text-blue-600 hover:text-blue-800 transition-colors">
