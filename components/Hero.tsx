      ...
      <div className="relative mx-auto max-w-4xl px-4 py-12 sm:py-20 text-center">
        <div className="space-y-6 sm:space-y-8">
          <div className="space-y-4 sm:space-y-6">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight text-white drop-shadow-2xl">
              Eye Glow
            ...
            <p className="text-base sm:text-lg text-gray-100 leading-relaxed max-w-2xl mx-auto drop-shadow-lg px-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            <div className="flex items-center gap-3 sm:gap-4">
              <span className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white drop-shadow-2xl">{localizedPrice}</span>
            ...
            <div className="flex items-center gap-1">
              {[...Array(5)].map((_, i) => (
                <svg key={i} className="w-4 h-4 sm:w-5 sm:h-5 drop-shadow-lg" fill="white" viewBox="0 0 20 20">
          ...
          {/* Trust Badges */}
          <div className="grid grid-cols-3 gap-3 sm:gap-6 pt-6 sm:pt-8 px-4">
